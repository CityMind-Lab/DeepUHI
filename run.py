...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, required=False, default='traffic_72_24', help='model id')
    parser.add_argument('--model', type=str, required=False, default='DeepUHI',
                        help='model name, options: [Autoformer, Informer, Transformer]')
    #self.args.PCI
    parser.add_argument('--PCI', type=int, default=1, help='0: no use, 1: use')
    # --data_folder $model_id_name \
    parser.add_argument('--data_folder', type=str, default='SeoulTemp', help='data folder')
    #configs.exsiting_adj==True:
    parser.add_argument('--exsiting_adj', type=bool, default=False, help='0: no use, 1: use')

    # data loader
    parser.add_argument('--group_file', type=str, default='./dataset/region_group.csv', help='group file path')

    parser.add_argument('--data', type=str, required=False, default='custom', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='Temperature/SDot_2021_2024_Updated.csv', help='data file')
    ...
    parser.add_argument('--enc_in', type=int, default=883, help='encoder input size') # DLinear with --individual, use this hyperparameter as the number of channels
    ...
    parser.add_argument('--devices', type=str, default='3, 1,2', help='device ids of multile gpus')
